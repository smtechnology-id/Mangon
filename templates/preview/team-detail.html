...
<body>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        ...
                                        <ul>
                                            ...
                                            <li class="active"><a href="team-detail.html">team details</a></li>
    ...
    <!-- start detail area -->
    <section class="team-page team-detail pt-120 pb-90">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-5">
                    <div class="personal-info wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1s">
                        <div class="image">
                                ...
                                <table class="table table-borderless table1">
                                    <thead>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td>tue</td>
                                          <td>12:00 pm - 09:30pm</td>
                                        </tr>
                                        <tr>
                                          <td>wed</td>
                                          <td>10:30 am - 05:30 pm</td>
                                        </tr>
                                      </tbody>
                                </table>
                            </div>
                        </div>
                        <div class="box wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1s">
                            <div class="title">
                                <h5>experiences</h5>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-borderless">
                                    <thead>
                                        <tr>
                                          <th scope="col" class="yar">year</th>
                                          <th scope="col" class="dept">depertment</th>
                                          <th scope="col" class="pos">position</th>
                                          <th scope="col" class="com">company</th>
                                        </tr>
                                      </thead>
                                      <tbody>
                                        <tr>
